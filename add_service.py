...
class Ui_Add_servis(object):
    def setupUi(self, Add_servis):
        ...
        self.dateTimeEdit_service = QtWidgets.QDateTimeEdit(Add_servis)
        self.dateTimeEdit_service.setGeometry(QtCore.QRect(30, 130, 194, 22))
        self.dateTimeEdit_service.setObjectName("dateTimeEdit_service")
    ...
    def retranslateUi(self, Add_servis):
        ...
        self.label_servis_data_time.setText(_translate("Add_servis", "Укажите дату и время"))
