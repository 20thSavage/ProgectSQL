...
class Ui_Add_servis(object):
    ...
    def retranslateUi(self, Add_servis):
        ...
        self.comboBox.setItemText(0, _translate("Add_servis", "123"))
        self.comboBox.setItemText(1, _translate("Add_servis", "2334"))
        self.comboBox.setItemText(2, _translate("Add_servis", "21414"))
        self.comboBox.setItemText(3, _translate("Add_servis", "2131"))
        self.comboBox.setItemText(4, _translate("Add_servis", "2"))
