...
class Ui_Add_doctor(object):
    def setupUi(self, Add_doctor):
        ...
        self.lineEdit_doctor_age = QtWidgets.QLineEdit(Add_doctor)
        self.lineEdit_doctor_age.setGeometry(QtCore.QRect(20, 120, 141, 22))
        self.lineEdit_doctor_age.setObjectName("lineEdit_doctor_age")
        self.lineEdit_doctor_position = QtWidgets.QLineEdit(Add_doctor)
        self.lineEdit_doctor_position.setGeometry(QtCore.QRect(210, 120, 141, 22))
        self.lineEdit_doctor_position.setObjectName("lineEdit_doctor_position")
        ...
        self.label_error_doctor_position = QtWidgets.QLabel(Add_doctor)
        self.label_error_doctor_position.setGeometry(QtCore.QRect(210, 150, 141, 20))
        self.label_error_doctor_position.setText("")
        self.label_error_doctor_position.setObjectName("label_error_doctor_position")
        self.label_error_age_of_doctor = QtWidgets.QLabel(Add_doctor)
        self.label_error_age_of_doctor.setGeometry(QtCore.QRect(20, 150, 141, 20))
        self.label_error_age_of_doctor.setText("")
        self.label_error_age_of_doctor.setObjectName("label_error_age_of_doctor")
    ...
    def retranslateUi(self, Add_doctor):
        ...
        self.label_doctor_age.setText(_translate("Add_doctor", "Укажите возраст доктора:"))
